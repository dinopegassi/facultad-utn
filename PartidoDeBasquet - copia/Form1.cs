...
{
    public partial class Form1Partido : Form
    {
        public Form1Partido()
        {
            InitializeComponent();
        ...
        {
            ResultadoFinal final = new ResultadoFinal();

            final.listBox1.Items.Add("Local --> "+l.VerMVP());
            final.listBox1.Items.Add("Visitante --> "+v.VerMVP());
