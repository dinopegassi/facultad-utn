...
public class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Console.Clear();
        otro_tp.Auxiliares.Marco();
        Console.SetCursorPosition(3, 3);
        Console.Write("Nombre: ");
        string nombre = Convert.ToString(Console.ReadLine());

        otro_tp.Auxiliares nombrecito = new otro_tp.Auxiliares(nombre);

        do
        {
            otro_tp.Auxiliares.Feriado();
        ...
        do
        {
            ...
            {
                //1er menu principal
                otro_tp.Auxiliares.Menu1();
                ConsoleKeyInfo key = Console.ReadKey();
                switch (key.Key)
                {
                    // INICIA tickets individuales
